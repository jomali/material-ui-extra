...
const useStyles = makeStyles(() => ({
  ...
  labelReadOnly: {
    color: `${fade("#ffffff", 0.7)} !important`,
  },
}));
...
/**
 * `UneditableTextField` is based on Material UI `TextField` implementation.
 * 
...
const TextField = React.forwardRef(function TextField(props, ref) {
  ...
  const InputComponent = readOnly
    ? variantComponent["standard"]
  ...
  return (
    ...
    >
      {label && (
        <InputLabel
          className={clsx({ [styles.labelReadOnly]: readOnly })}
          htmlFor={id}
          id={inputLabelId}
...
TextField.propTypes = {
  ...
  /**
   * If `true`, the text field is not editable anymore.
   */
